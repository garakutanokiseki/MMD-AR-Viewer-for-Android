...
/**
 * このクラスは、Idマーカのデータ部の値を格納します。 Idマーカのデータ仕様については、以下のURLを参照してください。
 * http://sourceforge.jp/projects/nyartoolkit/docs/standards_document0001/ja/2/
 * standards_document0001.pdf
 * 
 */
