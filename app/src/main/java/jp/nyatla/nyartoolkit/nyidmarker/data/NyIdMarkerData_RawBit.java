...
/**
 * このクラスは、RawBitタイプのデータを格納します。 RawBitタイプのデータは、NyIdマーカのデータパケットをそのまま配列にするだけです。
 */
public class NyIdMarkerData_RawBit implements INyIdMarkerData {
	...
	/**
	 * この関数は、i_targetのマーカデータとインスタンスのデータを比較します。 引数には、
	...
	/**
	 * この関数は、i_sourceからインスタンスにマーカデータをコピーします。 引数には、{@link NyIdMarkerData_RawBit}
	 * 型のオブジェクトを指定してください。
	 */
