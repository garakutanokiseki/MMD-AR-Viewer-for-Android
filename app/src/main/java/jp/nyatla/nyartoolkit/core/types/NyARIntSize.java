...
public class NyARIntSize {
	 ...
	 * @param i_y
	 *            比較するサイズ値(H)
	 * @return 引数値がインスタンスのサイズよりも小さければ、trueを返します。
	 * @throws NyARException
	 */
	 ...
	 *            計算対象とする要素の数
	 */
	public final void setAreaRect(NyARDoublePoint2d[] i_vertex,
			int i_num_of_vertex) {
		// エリアを求める。
