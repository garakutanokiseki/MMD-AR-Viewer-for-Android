 ...
 * </p>
 */
public class NyARHistogramAnalyzer_DiscriminantThreshold implements
	...
	public int getThreshold(NyARHistogram i_histogram) {
		...
		// max_mtを元に正規化
		this._score = max
				/ ((double) (pt + max_mt * max_mt * st - 2 * max_mt * dt) / st);// 129,0.8888888888888887
		return th;
	}
