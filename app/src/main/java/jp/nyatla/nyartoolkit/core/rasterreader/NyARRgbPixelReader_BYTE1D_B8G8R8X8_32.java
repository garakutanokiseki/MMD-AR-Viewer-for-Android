 ...
 */
final public class NyARRgbPixelReader_BYTE1D_B8G8R8X8_32 implements
		INyARRgbPixelReader {
	/** 参照する外部バッファ */
	 ...
	 *            ラスタのサイズオブジェクトの参照値。
	 */
	public NyARRgbPixelReader_BYTE1D_B8G8R8X8_32(byte[] i_ref_buf,
			NyARIntSize i_size) {
	...
	public void switchBuffer(Object i_ref_buffer) throws NyARException {
		assert (((byte[]) i_ref_buffer).length >= this._ref_size.w
				* this._ref_size.h * 4);
