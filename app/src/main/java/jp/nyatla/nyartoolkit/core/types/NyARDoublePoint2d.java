...
/**
 * このクラスはデータ型です。 ２次元の浮動小数点座標を格納します。
 */
public class NyARDoublePoint2d {
	 ...
	 * @return 新しい配列。
	 */
	public static NyARDoublePoint2d[][] create2dArray(int i_length_x,
			int i_length_y) {
	...
	/**
	 * この関数は、３点で定義される直線から、外積を計算します。 外積は、p1->p2と、p2->p3で定義する直線の外積です。
	 * 
	 * @param p1
	 *            点１
	 * @param p2
	 ...
	 * @return 外積の値
	 */
	public final static double crossProduct3Point(NyARDoublePoint2d p1,
			NyARDoublePoint2d p2, NyARDoublePoint2d p3) {
	 ...
	 */
	public final static double crossProduct3Point(NyARDoublePoint2d p1,
			NyARDoublePoint2d p2, double p3_x, double p3_y) {
	 ...
	 *            中央値を受け取るオブジェクトです。
	 */
	public final static void makeCenter(NyARDoublePoint2d[] i_points,
			int i_number_of_data, NyARDoublePoint2d o_out) {
		double x, y;
		x = y = 0;
	 ...
	 */
	public final static void makeCenter(NyARDoublePoint2d[] i_points,
			int i_number_of_data, NyARIntPoint2d o_out) {
		double lx, ly;
		lx = ly = 0;
		for (int i = i_number_of_data - 1; i >= 0; i--) {
			lx += i_points[i].x;
	...
	/**
	 * コンストラクタです。 初期値を格納したインスタンスを生成します。
	 */
	...
	/**
	 * コンストラクタです。 i_srcの値で初期化したインスタンスを生成します。
	 * 
	 * @param i_src
	 *            初期値とするオブジェクト
	 */
