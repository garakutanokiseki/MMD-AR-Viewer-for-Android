...
/**
 * このクラスは、整数型の２次元輪郭線を格納します。 輪郭線は、２次元座標{@link NyARIntPoint2d}の集合です。
 */
public class NyARIntCoordinates {
	...
	/**
	 * コンストラクタです。 最大長さを指定して、有効要素数0のインスタンスを作ります。
	 * 
	 * @param i_length
	 *            輪郭の最大長
	 */
	...
	/**
	 * この関数は２点を結ぶ直線を計算して、輪郭線を保存します。 輪郭線は、Bresenhamのアルゴリズムで計算します。
