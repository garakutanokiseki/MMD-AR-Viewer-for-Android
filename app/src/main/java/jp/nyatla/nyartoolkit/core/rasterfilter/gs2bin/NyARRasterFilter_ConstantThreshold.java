...
/**
 * このクラスは、固定敷居値を用いて、画像を２値化します。 入力できるラスタ、出力できるラスタの形式は以下の通りです。
 * <ul>
 * <li>入力形式 - {@link NyARBufferType#INT1D_GRAY_8}
 * <li>出力形式 - {@link NyARBufferType#INT1D_BIN_8}
 * </ul>
 */
public class NyARRasterFilter_ConstantThreshold implements
		INyARRasterFilter_Gs2Bin {
	/** 敷居値。 */
	 ...
	 */
	public NyARRasterFilter_ConstantThreshold(int i_initial_threshold,
	...
	/**
	 * コンストラクタです。 入力ラスタ形式={@link NyARBufferType#INT1D_GRAY_8},出力ラスタ形式=
	 * {@link NyARBufferType#INT1D_BIN_8}, 初期敷居値=0でインスタンスを生成します。
	 * 
	 * @throws NyARException
	 */
	...
	/**
	 * この関数は、固定敷居値で画像を２値化します。 現在の敷居値以下の画素が0になり、その他の画素は1になります。
	 */
