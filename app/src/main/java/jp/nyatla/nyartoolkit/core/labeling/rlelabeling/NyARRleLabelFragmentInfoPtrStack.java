...
/**
 * このクラスは、{@link NyARRleLabelFragmentInfo}の参照値の動的配列です。 {@link NyARLabeling_Rle}
 * が使います。 {@link NyARPointerStack}からの追加機能として、配列要素のソート機能があります。
 */
public class NyARRleLabelFragmentInfoPtrStack extends
		NyARPointerStack<NyARRleLabelFragmentInfo> {
