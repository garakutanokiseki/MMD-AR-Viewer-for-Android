...
public class NyARMath {
	 ...
	 * @return 二乗距離値
	 */
	public static final double sqNorm(double i_p1x, double i_p1y, double i_p2x,
			double i_p2y) {
		double x, y;
		x = i_p2x - i_p1x;
		y = i_p2y - i_p1y;
	 ...
	 * @return 距離値
	 */
	public static final double dist(double i_x1, double i_y1, double i_x2,
			double i_y2) {
	...
	/**
	 * この関数は、ユークリッドの互除法により、最大公約数を求めます。 出典
	 * http://ja.wikipedia.org/wiki/%E3%83%A6%
	 * E3%83%BC%E3%82%AF%E3%83%AA%E3%83%83
	 * %E3%83%89%E3%81%AE%E4%BA%92%E9%99%A4%E6%B3%95
	 * 
	 * @param i_x
	 *            最大公約数を求める数1
	 * @param i_y
