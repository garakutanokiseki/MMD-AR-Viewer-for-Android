...
/**
 * このクラスは、画像のヒストグラムから{@link NyARHistogramAnalyzer_SlidePTile}
 * による敷居値検出をする機能を提供します。
 */
public class NyARRasterThresholdAnalyzer_SlidePTile implements
	...
	/**
	 * コンストラクタ。 {@link NyARHistogramAnalyzer_SlidePTile}
	 * に渡すパラメータを指定して、敷居値分析器を作成します。
	 * 
	 * @param i_persentage
	 *            {@link NyARHistogramAnalyzer_SlidePTile#NyARHistogramAnalyzer_SlidePTile}
	 *            へ渡す分析パラメータです。
	...
	/**
	 * この関数は、インスタンスの初期化関数です。 継承クラスを作るときには、この関数をオーバライドします。
	 * 
	 * @param i_raster_format
	 * @see NyARRasterThresholdAnalyzer_SlidePTile#NyARRasterThresholdAnalyzer_SlidePTile(int,
	 *      int, int)
	 * @param i_vertical_interval
	 * @see NyARRasterThresholdAnalyzer_SlidePTile#NyARRasterThresholdAnalyzer_SlidePTile(int,
	 *      int, int)
	...
	protected boolean initInstance(int i_raster_format, int i_vertical_interval)
			throws NyARException {
		this._raster_analyzer = new NyARRasterAnalyzer_Histogram(
				i_raster_format, i_vertical_interval);
		return true;
	}
	...
	/**
	 * {@link NyARHistogramAnalyzer_SlidePTile}による敷居値分析を実行します。 この関数は未実装です。
	 */
