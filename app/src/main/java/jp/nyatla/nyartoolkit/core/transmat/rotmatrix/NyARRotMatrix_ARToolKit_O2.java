...
/**
 * 回転行列計算用の、3x3行列 計算方法はARToolKitと同じだが、ARToolKitにある不要な行列から角度を逆算する
...
public class NyARRotMatrix_ARToolKit_O2 extends NyARRotMatrix_ARToolKit {
	...
	// override
	public final void setAngle(final double i_x, final double i_y,
			final double i_z) {
		...
		this.m00 = CACA * cosb * cosc + SASA * cosc + SACACB * sinc - SACA
				* sinc;
		this.m01 = -CACA * cosb * sinc - SASA * sinc + SACACB * cosc - SACA
				* cosc;
		this.m02 = CASB;
		this.m10 = SACACB * cosc - SACA * cosc + SASA * cosb * sinc + CACA
				* sinc;
		this.m11 = -SACACB * sinc + SACA * sinc + SASA * cosb * cosc + CACA
				* cosc;
		this.m12 = SASB;
