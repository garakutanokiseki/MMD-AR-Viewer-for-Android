...
/**
 * このクラスは、空のラスタを定義します。 空のラスタは、バッファを持たないサイズのみのラスタです。デバックなどに使います。
 */
public class NyARRgbRaster_Blank extends NyARRgbRaster_BasicClass {
	...
	/**
	 * コンストラクタです。 バッファの参照方法を指定して、インスタンスを生成します。
	 * 
	 * @param i_width
	 *            ラスタサイズ
	 * @param i_height
	...
	/**
	 * この関数は、ラスタのバッファへの参照値を返します。 常にNULLです。
	 */
	...
	/**
	 * この関数は、インスタンスがバッファを所有するかを返します。 内部参照バッファの場合は、常にfalseです。
	 */
	...
	/**
	 * この関数は、ラスタに外部参照バッファをセットします。 このクラスでは使用できません。
	 */
