...
public class NyARHistogram {
	 ...
	 * ヒストグラムを格納する配列です。
	 * <p>
	 * 注意 - 配列の長さ({@link #data})と{@link #length}の意味は異なります。
	 * ヒストグラムの解像度に、この配列の長さを使わないでください。
	 * </p>
	 */
	public final int[] data;
	/**
	 * ヒストグラムの解像度です。 {@link #data}配列の0から{@link #length}-1までの要素が、アクセス可能な要素です。
	 */
	public int length;
	/**
	 * ヒストグラムの合計値です。 ヒストグラム分析器は、ここにヒストグラム要素の合計値を書込みます。
	 */
	public int total_of_data;

	/**
	 * コンストラクタです。 ヒストグラムの解像度を指定してインスタンスを作ります。
	 * 
	 * @param i_length
	...
	/**
	 * この関数は、指定したインデクス以下のヒストグラム要素を0にします。 　実行結果は、{@link #total_of_data}に反映されます。
	 * 
	 * @param i_pos
	 *            操作するヒストグラム要素のインデクス値。
	 */
	...
	/**
	 * この関数は、指定したインデクス以上のヒストグラム要素を0にします。 　実行結果は、{@link #total_of_data}に反映されます。
	 * 
	 * @param i_pos
	 *            操作するヒストグラム要素のインデクス値。
	 */
