...
/**
 * このクラスは、HSV画像を格納するラスタクラスです。 内部バッファのみに対応します。
 */
public final class NyARHsvRaster extends NyARRaster_BasicClass {
	...
	/**
	 * この関数は、ラスタのバッファへの参照値を返します。 バッファの形式{@link NyARBufferType#INT1D_X7H9S8V8_32}
	 * です。
	 */
	...
	/**
	 * この関数は、インスタンスがバッファを所有するかを返します。 このクラスでは内部参照バッファのみをサポートするため、常にtrueです。
	 */
