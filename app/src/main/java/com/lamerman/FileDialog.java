...
public class FileDialog extends ListActivity {
	...
	public static final String EXTENTION_FILTER = "EXTENTION_FILTER";
	...
	private void getDirImpl(final String dirPath) {
		...
		final String[] extentions = getIntent().getStringArrayExtra(
				EXTENTION_FILTER);
		if (extentions != null && 0 < extentions.length) {
			files = f.listFiles(new FileFilter() {
				...
				public boolean accept(File pathname) {
					...
					for (String extention : extentions) {
						if (pathname.getName().endsWith(extention)) {
							return true;
						}
					}
